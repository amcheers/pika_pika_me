...
pokemon = Pokemon.new(name: 'Bulbasaur', description: "For some time after its birth, it grows by gaining nourishment from the seed on its back.", class:"grass", price_per_day: 50)
...
pokemon = Pokemon.new(name: 'Charizard', description: "It is said that Charizards fire burns hotter if it has experienced harsh battles.", class:"fire", price_per_day: 176)
...
pokemon = Pokemon.new(name: 'Beedrill', description: "It has three poisonous stingers on its forelegs and its tail. They are used to jab its enemy repeatedly.", class:"bug", price_per_day: 76)
...
pokemon = Pokemon.new(name: 'Pikachu', description: "Pikachu that can generate powerful electricity have cheek sacs that are extra soft and super stretchy.", class:"electro", price_per_day: 134)
...
pokemon = Pokemon.new(name: 'Clefairy', description: "It is said that happiness will come to those who see a gathering of Clefairy dancing under a full moon.", class:"fairy", price_per_day: 86)
...
pokemon = Pokemon.new(name: 'Oddish', description: "If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.", class:"grass", price_per_day: 67)
...
pokemon = Pokemon.new(name: 'Dugtrio', description: "A team of Diglett triplets. It triggers huge earthquakes by burrowing 60 miles underground.", class:"ground", price_per_day: 104)
...
pokemon = Pokemon.new(name: 'Meowth', description: "It loves to collect shiny things. If it’s in a good mood, it might even let its Trainer have a look at its hoard of treasures.", class:"normal", price_per_day: 54)
