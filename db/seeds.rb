...
User.create(email: "test@user.com", password: "123456", address: "ijsbaanpad 9, Amsterdam")
User.create(email: "test@user2.com", password: "123456", address: "graafschapstraat 15, Amsterdam")
